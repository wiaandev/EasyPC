...
let PartData: [Part] = [
    Part(icon: "cpu", partType: "CPU", desc: "Click the card to learn how to install a cpu", longDesc: "The Central Processing Unit (CPU) functions as the brain of the computer. It has a lot of pins on the back-side of the processor, if it is an Intel CPU, but a lot of open contacts if it is an AMD processor.", image: "cpuImg", instructions: ["NOTE: Make sure you do not touch the side that has pins", "Look for the golden triangle located on one of the four corners of the CPU", "align that with the triangle on the motherboard socket"], tools: ["Anti-Static Wristband"], key: "cpu"),
    
    Part(icon: "memorychip", partType: "RAM", desc: "Click the card to learn how to install RAM", longDesc: "The Random Access Memory (RAM) holds the information of your current session. The RAM plays an important part of the multi-tasking capability of your computer, so the higher the speed and the more amounts of GB's you can get, the better.", image: "cpuImg", instructions: ["NOTE: Make sure you do not touch the side that has pins", "Look for the golden triangle located on one of the four corners of the CPU", "align that with the triangle on the motherboard socket"], tools: ["Anti-Static Wristband"], key: "ram"),
